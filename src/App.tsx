    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl space-y-6 px-6 py-6">
        ...
        <p className="text-[11px] text-slate-400 -mt-3">
          ¹ CET ajustado: crédito trazido a valor presente pelo IPCA anual — creditoPV = crédito ÷ (1 + IPCA)^(k/12) —
          e depois composto com a valorização do bem: (1 + CET) × (1 + valorização) − 1. Reflete o custo de aguardar
          a contemplação enquanto o imóvel aprecia além da correção contratual. O financiamento recebe o crédito
          em t=0 e não sofre ajuste.
        </p>
