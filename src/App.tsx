    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl space-y-6 px-6 py-6">
        ...
        <p className="text-[11px] text-slate-400 -mt-3">
          ¹ CET ajustado = CET padrão composto com a valorização anual do bem informada: (1 + CET) × (1 + valorização) − 1.
          Reflete o custo de oportunidade de aguardar a contemplação enquanto o imóvel aprecia além da correção contratual.
